    ...
    <div className="flex-1 min-w-0">
      ...
      {lessons.length === 0 ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-10 text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">The instructor is still building this course.</p>
        </div>
      ) : (
        /* Lessons list */
          ...
          {lessons.map((lesson, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {lesson.description && (
                  <p className="text-sm text-gray-400 mt-1 leading-relaxed">{lesson.description}</p>
                )}
              </div>
